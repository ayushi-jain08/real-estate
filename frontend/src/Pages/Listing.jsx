...
import {createListings } from '../Redux/Slice/ListingSlice'
...
const handleImageChange = (e) => {
  ...
  for (let i = 0; i < selectedFiles.length; i++) {
    ...
    imagePreviews.push(imageURL); // Push the URL for preview
  }

  setImages(newImages); // Update the state with the file objects if needed
  setImagePreview(imagePreviews); // Update the state with image preview URLs
